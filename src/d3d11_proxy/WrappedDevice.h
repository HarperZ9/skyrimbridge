#pragma once
//=============================================================================
//  WrappedDevice — ID3D11Device wrapper for resource tracking
//=============================================================================
...
class WrappedDevice : public ID3D11Device
{
public:
    WrappedDevice(ID3D11Device* real, WrappedContext* wrappedCtx);
    ~WrappedDevice();
